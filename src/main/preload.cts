...
contextBridge.exposeInMainWorld('mbot', {
  ...
  connectDevice: (ip: string, port: number, mdnsName?: string) => ipcRenderer.invoke('device:connect', ip, port, mdnsName),
  ...
  getSavedDevices: () => ipcRenderer.invoke('device:savedDevices'),
  removeSavedDevice: (key: string) => ipcRenderer.invoke('device:removeSaved', key),
  forgetDevice: (serial: string) => ipcRenderer.invoke('device:forget', serial),
  reconnectSavedDevices: () => ipcRenderer.invoke('device:reconnect'),
